...
public class ArticleControllerTests {
    ...
    void create_article() {
        ...
        String contents = "나는 우아한형제들에서 우아한테크코스 교육 과정을 진행하고 있다. 우테코를 설계하면서 고민스러웠던 부분 중의 하나는 선발 과정을 어떻게 하면 의미 있는 시간으로 만들 것인가였다.";
    ...
    void 게시글_페이지_정상_조회() {
        ...
        String coverUrl = "urlTest";
        String contents = "contentsTest";
        articleRepository.insert(new Article(id, title, coverUrl, contents));
    ...
    void 존재하지_않는_게시글_조회_에러() {
        webTestClient.get()
                .uri("/articles/" + articleRepository.nextId())
                .exchange()
