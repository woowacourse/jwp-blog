...
public class UserServiceTests {
    ...
    void 모든_유저_정상_조회() {
        ...
        given(userAssembler.convertToUserResponse(USER_1)).willReturn(USER_RESPONSE_1);
        given(userAssembler.convertToUserResponse(USER_2)).willReturn(USER_RESPONSE_2);
