...
class ArticleWriteServiceTests extends ArticleCommonServiceTests {
    ...
    void update_test() {
        ...
        assertDoesNotThrow(() -> articleWriteService.update(articleId, UPDATE_ARTICLE_FEATURE, author));

        compareArticle(articleRepository.findById(articleId).get(), UPDATE_ARTICLE_FEATURE.toArticle(author));
    }
}
