INSERT INTO user(email, name, password) VALUES ('test@test.test', 'base', 'passWORD1!');
...
INSERT INTO user(email, name, password) VALUES ('test2@test.test', 'mismatch', 'passWORD1!');
